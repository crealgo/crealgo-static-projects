...
`,M=e=>r("li",{id:e.id,className:e.className,children:[r("figure",{className:"image",children:[i("img",{...e.image}),i(z,{className:"marker",children:e.stepNumber??1})]}),r("div",{className:"content",children:[i("div",{className:"title",children:e.title}),i("div",{className:"description",children:e.description}),e.children]}),i(G,{className:"connector"})]}),c=n(M)`
...
`,O=e=>r("li",{id:e.id,className:e.className,children:[i(V,{className:"marker",children:e.stepNumber??1}),i("figure",{className:"image",children:i("img",{...e.image})}),r("div",{className:"content",children:[i("div",{className:"title",children:e.title}),i("div",{className:"description",children:e.description}),e.children]}),i(F,{className:"connector"})]}),l=n(O)`
	padding-inline: 1rem;
	gap: 5.75rem;
...
`;try{l.displayName="TimelineEvent",l.__docgenInfo={description:"",displayName:"TimelineEvent",props:{stepNumber:{defaultValue:null,description:"",name:"stepNumber",required:!1,type:{name:"number"}},title:{defaultValue:null,description:"",name:"title",required:!1,type:{name:"string"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},image:{defaultValue:null,description:"",name:"image",required:!1,type:{name:"{ src: string; alt: string; }"}}}}}catch{}const p=n("ol")`
	max-width: 63.75rem;
	margin-inline: auto;
	padding-inline: 0;
`;try{p.displayName="Timeline",p.__docgenInfo={description:"",displayName:"Timeline",props:{}}}catch{}y("div")`
	display: flex;
	gap: 0.25rem;
	align-items: center;
	justify-content: center;
...
`,g=({events:e})=>{const{breakpoints:v}=S(),w=B(v.down("sm")),[k,q]=x.useState(0),T=w?c:l;return r(P,{className:"EventBlock-root",children:[i(I,{children:r(_,{isCentered:!0,level:2,className:"mb-4",children:["See how ",i(N,{color:"magenta",children:"Screen Print"})]})}),i(p,{children:E[k].steps.map((s,m)=>i(T,{stepNumber:m+1,title:s.title,description:s.description,image:s.image},m))})]})};try{g.displayName="TimelineBlock",g.__docgenInfo={description:"",displayName:"TimelineBlock",props:{events:{defaultValue:null,description:"",name:"events",required:!1,type:{name:"EventBlockProps[]"}}}}}catch{}const se={component:g},a={args:C()};var f,b,u;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: generateTimelineBlock()
}`,...(u=(b=a.parameters)==null?void 0:b.docs)==null?void 0:u.source}}};const ce=["Default"];export{a as Default,ce as __namedExportsOrder,se as default};
//# sourceMappingURL=TimelineBlock.stories-fdc5a8b4.js.map
