...
`,z=n("div")`
	...
	border-left: dotted ${B} #cbd5e1;
`,E=e=>r("li",{id:e.id,className:e.className,children:[r("figure",{className:"image",children:[i("img",{...e.image}),i($,{className:"marker",children:e.stepNumber??1})]}),r("div",{className:"content",children:[i("div",{className:"title",children:e.title}),i("div",{className:"description",children:e.description}),e.children]}),i(z,{className:"connector"})]}),c=n(E)`
...
`;try{c.displayName="MobileTimelineEvent",c.__docgenInfo={description:"",displayName:"MobileTimelineEvent",props:{stepNumber:{defaultValue:null,description:"",name:"stepNumber",required:!1,type:{name:"number"}},title:{defaultValue:null,description:"",name:"title",required:!1,type:{name:"string"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},image:{defaultValue:null,description:"",name:"image",required:!1,type:{name:"{ src: string; alt: string; }"}}}}}catch{}const d=n("ol")`
	max-width: 63.75rem;
	margin-inline: auto;
	padding-inline: 0;
`;try{d.displayName="Timeline",d.__docgenInfo={description:"",displayName:"Timeline",props:{}}}catch{}const t="0.25rem",o="3.5rem",l="4rem",G=n("div")`
	height: ${o};
	width: ${o};
...
`,M=n("div")`
	...
	border: dotted ${t} var(--image-background-color);
`,V=e=>r("li",{id:e.id,className:e.className,children:[i(G,{className:"marker",children:e.stepNumber??1}),i("figure",{className:"image",children:i("img",{...e.image})}),r("div",{className:"content",children:[i("div",{className:"title",children:e.title}),i("div",{className:"description",children:e.description}),e.children]}),i(M,{className:"connector"})]}),p=n(V)`
	padding-inline: 1rem;
	gap: 5.75rem;
...
`;try{p.displayName="TimelineEvent",p.__docgenInfo={description:"",displayName:"TimelineEvent",props:{stepNumber:{defaultValue:null,description:"",name:"stepNumber",required:!1,type:{name:"number"}},title:{defaultValue:null,description:"",name:"title",required:!1,type:{name:"string"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},image:{defaultValue:null,description:"",name:"image",required:!1,type:{name:"{ src: string; alt: string; }"}}}}}catch{}const F=T(P)`
	display: grid;
	gap: 1rem;
...
`,g=()=>{const{breakpoints:e}=_(),y=N(e.down("sm")),v=0,w=y?c:p;return r(C,{className:"EventBlock-root",children:[i(F,{children:r(x,{isCentered:!0,level:2,className:"mb-4",children:["See how we ",i(D,{color:"magenta",children:"Screen Print"})]})}),i(d,{children:S[v].steps.map((s,m)=>i(w,{stepNumber:m+1,title:s.title,description:s.description,image:s.image},m))})]})};try{g.displayName="TimelineBlock",g.__docgenInfo={description:"",displayName:"TimelineBlock",props:{events:{defaultValue:null,description:"",name:"events",required:!1,type:{name:"EventBlockProps[]"}}}}}catch{}const oe={component:g},a={args:k()};var f,b,u;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: generateTimelineBlock()
}`,...(u=(b=a.parameters)==null?void 0:b.docs)==null?void 0:u.source}}};const se=["Default"];export{a as Default,se as __namedExportsOrder,oe as default};
//# sourceMappingURL=TimelineBlock.stories-81152ae9.js.map
