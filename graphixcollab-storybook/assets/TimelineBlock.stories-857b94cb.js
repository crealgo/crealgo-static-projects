...
`,G=e=>r("li",{id:e.id,className:e.className,children:[r("figure",{className:"image",children:[i("img",{...e.image}),i($,{className:"marker",children:e.stepNumber??1})]}),r("div",{className:"content",children:[i("div",{className:"title",children:e.title}),i("div",{className:"description",children:e.description}),e.children]}),i(z,{className:"connector"})]}),c=n(G)`
...
`;try{c.displayName="MobileTimelineEvent",c.__docgenInfo={description:"",displayName:"MobileTimelineEvent",props:{}}}catch{}const d=n("ol")`
	max-width: 63.75rem;
	margin-inline: auto;
	padding-inline: 0;
`;try{d.displayName="Timeline",d.__docgenInfo={description:"",displayName:"Timeline",props:{}}}catch{}const t="0.25rem",o="3.5rem",l="4rem",E=n("div")`
	height: ${o};
	width: ${o};
...
`,F=e=>r("li",{id:e.id,className:e.className,children:[i(E,{className:"marker",children:e.stepNumber??1}),i("figure",{className:"image",children:i("img",{...e.image})}),r("div",{className:"content",children:[i("div",{className:"title",children:e.title}),i("div",{className:"description",children:e.description}),e.children]}),i(M,{className:"connector"})]}),g=n(F)`
	padding-inline: 1rem;
	gap: 5.75rem;
...
`;try{g.displayName="TimelineEvent",g.__docgenInfo={description:"",displayName:"TimelineEvent",props:{}}}catch{}const O=T(P)`
	display: grid;
	gap: 1rem;
...
`,p=()=>{const{breakpoints:e}=_(),y=N(e.down("sm")),v=0,w=y?c:g;return r(C,{className:"EventBlock-root",children:[i(O,{children:r(x,{isCentered:!0,level:2,className:"mb-4",children:["See how we ",i(D,{color:"magenta",children:"Screen Print"})]})}),i(d,{children:S[v].steps.map((s,m)=>i(w,{stepNumber:m+1,title:s.title,description:s.description,image:s.image},m))})]})};try{p.displayName="TimelineBlock",p.__docgenInfo={description:"",displayName:"TimelineBlock",props:{events:{defaultValue:null,description:"",name:"events",required:!1,type:{name:"any[]"}}}}}catch{}const se={component:p},a={args:k()};var f,b,u;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
...
//# sourceMappingURL=TimelineBlock.stories-857b94cb.js.map
